...
import type { PersonType, UserType } from "$lib/srv/model";
...
setContext("userPeople", writable<Partial<PersonType[]>>(data.people))
...
<div>
	<NewChart show={showNewChartModal} on:close={()=>{showNewChartModal = false}} />
