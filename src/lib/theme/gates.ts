...
export const builder = buildGatesConfig<GateArgs>({
	...
	'6': [fact(-0.34), middleChannelY],
	'22': [fact(0.03), fact(-0.29)],
	'30': [fact(0.25), fact(0.37)],
	'36': [fact(0.25), fact(-0.37)],
	'37': [fact(-0.17), fact(-0.17)],
	'49': [fact(-0.17), fact(0.17)],
	'55': [fact(0.03), fact(0.29)],
	...
	'18': [fact(-0.25), fact(0.37)],
	'28': [fact(-0.03), fact(0.29)],
	'57': [fact(-0.03), fact(-0.29)],
	'32': [fact(0.17), fact(0.17)],
	'44': [fact(0.17), fact(-0.17)],
	'48': [fact(-0.25), fact(-0.37)],
	'50': [fact(0.34), middleChannelY],
	...
	'26': [fact(-0.38), fact(0.14)],
	'40': [fact(0.26), fact(0.3)],
	'51': [fact(-0.17), fact(-0.09)]
});
